  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-gray-900">Informe de Ingresos</h1>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        {error ? (
          <div className="p-6 text-center">
            <p className="text-red-600">Error al cargar los ingresos. Verifica que estés logueado.</p>
          </div>
        ) : (
          <DataTable
            columns={columns}
      ...
      {pagos?.data && pagos.data.length > 0 && (
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <h2 className="text-lg font-semibold mb-4">Resumen de Ingresos</h2>
